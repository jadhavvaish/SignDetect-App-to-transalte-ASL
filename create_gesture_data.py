...
while True:
    ...
    cv2.putText(frame_copy, "DataFlair hand sign recognition_ _ _", (80, 20), cv2.FONT_ITALIC, 0.5, (51, 255, 51), 1)
    ...
    #Time to configure the hand specifically into the ROI...
        ...
        print("We have frame <=300")

        cv2.putText(frame_copy, "Adjust hand...Gesture for" + str(element), (80, 400), cv2.FONT_HERSHEY_SIMPLEX, 1,  (0, 0, 255), 2)
